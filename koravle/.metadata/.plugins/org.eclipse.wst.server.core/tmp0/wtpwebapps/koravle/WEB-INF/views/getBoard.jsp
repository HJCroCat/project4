...
<body>
	...
	<div style="max-width:1000px; margin:auto;">
		...
		<div class="row">
			<div class="col-3">${board.boardIdx}</div>
		...
		<div class="row">
			...
			<div class="col-3">${board.boardCat}</div> <!-- 한글 출력으로 변경 -->
		</div>
		...
		<div class="row">
			<button class="col-2" onclick='location.href="getBoardList.do"'>글목록</button>
			<button class="col-2" onclick='location.href="insertBoard.do"'>새 글쓰기</button>
			
			<div class="col-4"></div>
			
			<%-- <c:if <%=usrID%>==${board.Writer}> --%>
				<button class="col-2" onclick='location.href="updatePage.do?boardIdx=${board.boardIdx}"'>수정</button>
